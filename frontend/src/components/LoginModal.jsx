...
export default function LoginModal() {
  const { login, register, loginWithGoogle, quickDemoLogin, isSupabaseEnabled } = useAuth();
      ...
      <div className="relative sm:mx-auto sm:w-full sm:max-w-lg">
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-md">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-2.5 px-4 rounded-xl bg-white hover:bg-slate-100 text-slate-800 font-bold text-xs sm:text-sm border border-slate-200 shadow-sm transition-all flex items-center justify-center gap-3 mb-4"
          >
          ...
          {error && (
            <div className="mb-5 p-3.5 rounded-xl bg-red-950/50 border border-red-800 text-red-300 text-xs flex items-center gap-2">
